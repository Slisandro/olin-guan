        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">The sun terrace</Text>
                </View>

                <View className="bg-white flex-1 mt-[10px] gap-[20px] pb-[30px] w-full">

                    <View className="px-[20px] w-auto py-[10px] rounded-[16px] right-[16px] backdrop-blur-[50px] flex flex-row items-center gap-2">
                    ...
                    <Pressable style={styles.container} className='relative shadow-soft-gray rounded-[16px] bg-red'>
                        <Image
                    ...
                    <View className="flex gap-[15px] px-[20px]">
                        ...
                        <Text className='font-poppins text-[14px] text-[#646464]'>
                            A vibrant place with a welcoming atmosphere, perfect for enjoying an unforgettable evening.
                        </Text>

                        <View className="relative shadow-md shadow-[#97C3FF66] px-[10px] py-[15px] bg-white rounded-[12px]">
                            <View className="absolute top-0 bottom-0 right-[10px] flex items-center justify-center">
                                <Text className="text-[]">6:00 PM - 2:00 AM</Text>
                            </View>
                            <TextInput placeholderTextColor={"#646464"} className="text-[#646464] text-[14px] font-[500]" placeholder="Schedule" />
                        </View>

                        <View className="flex-row items-center justify-between">
                            <View className="h-auto gap-3">
                                <Text className='font-poppins-bold font-700 text-[16px] leading-[19px] border-b text-[#1B77F2]'>{"Special events"}</Text>
                                <View className="h-[4px] border-2 border-[#1B77F2] mt-auto w-full" />
                            </View>

                            {
                                ["Reviews", "Security", "Entrace"].map((item) =>
                                    <View key={item} className="h-auto gap-3">
                                        <Text className='font-poppins-bold font-700 text-[16px] text-text-600 leading-[19px]'>{item}</Text>
                                        <View className="h-[4px] border-2 border-white bg-transparent mt-auto w-full" />
                                    </View>
                                )
                            }
                        </View>

                        <Pressable style={[styles.container, { borderRadius: 12, height: 500, backgroundColor: "trasparent", gap: 5 }]} className='shadow-soft-gray rounded-[16px] bg-red'>
                            <Image
                                source={BACKGROUND_IMAGE_1}
                                style={[styles.image, { borderRadius: 12, height: "80%" }]}
                            />

                            <View className="mt-2 gap-2">
                                <Text style={[{ lineHeight: 22, fontSize: 20, color: "#646464", fontWeight: 700 }]} className="font-poppins-bold">Happy hour</Text>
                                <Text style={[{ lineHeight: 14, fontSize: 14, color: "#646464" }]}>Promotions: 2 for 1 on drinks from 8 PM to 10 PM</Text>
                                <Text style={[{ lineHeight: 14, fontSize: 14, color: "#646464" }]}>Special Events: Happy Hour, Ladies Night</Text>
                            </View>
                        </Pressable>
                        ...
                        <View className="h-auto w-full flex-row gap-4">
                            <Pressable onPress={() => router.push("/(private)/(bar)/bar-reservation")} className="flex-1 rounded-[16px] py-[16px] bg-[#D9E6F8] border-[1.5px] border-[#1B77F2] items-center">
                                <Text className='text-[16px] font-poppins-semibold text-[#1B77F2]'>Reserve a table</Text>
                            </Pressable>

                            <Pressable onPress={() => router.push("/(private)/(bar)/bar-reservation")} className="flex-1 rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                                <Text className='text-[16px] font-poppins-semibold text-white'>Book a ticket</Text>
                            </Pressable>
                        </View>
