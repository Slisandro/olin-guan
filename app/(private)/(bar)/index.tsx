        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">What are your plans tonight?</Text>
    ...
    return (
        <View className="gap-[16px] py-[16px]">
            {ITEMS_BEST_FOOD.map(item => (
                <Pressable key={item.id} onPress={() => router.push("/(private)/(bar)/detail")} className="bg-white gap-2 rounded-[16px] w-auto h-auto shadow-sm">
