    ...
    return (
        ...
        >
            ...
            >
                ...
                <View className="bg-white flex-1 mt-[20px] pt-[30px] gap-[20px] pb-[30px] w-full">
                    ...
                    <View className="bg-white w-full">
                        <FlatList
                            renderItem={({ item }) => (
                                <Pressable
                                    className={`bg-white rounded-[16px] h-auto shadow-md shadow-[#97C3FF66] w-full my-2`}
                                    onPress={() => router.push("/(private)/(properties)/detail")}
                                >
                                    <View className='relative h-[200px] flex-row'>
                                    ...
                                    <View className="h-auto px-[12px] pt-[5px] pb-[10px] flex-1 gap-2">
                                        <View className="flex-row justify-between items-center">
                                            ...
                                            <Text className="font-poppins-bold font-700 text-[12px] text-[#6E6E70]">Inmobiliaria Egypt-House</Text>
                                        </View>
                                        <Text className="font-poppins-bold font-700 text-[16px] text-[#646464]">Casa bonita</Text>
                                        <Text className="font-poppins font-400 text-[14px] text-[#8A8A8A]">House located in the center</Text>
                                        <View className="flex-row gap-2 items-center">
                                            <Text className="text-[#6E6E70] text-[24px] font-poppins-bold">2</Text>
                                            <Svg
                                                width={30}
                                                height={30}
                                                viewBox="0 0 30 30"
                                            ...
                                            <Text className="text-[#6E6E70] text-[24px] font-poppins-bold ml-2">3</Text>
                                            <Svg
                                                width={30}
                                                height={30}
                                                viewBox="0 0 30 30"
                                            ...
                                            <Text className="text-[#6E6E70] text-[24px] font-poppins-bold ml-2">1</Text>
                                            <Svg
                                                width={30}
                                                height={30}
                                                viewBox="0 0 30 30"
                                        ...
                                        <Text className="font-poppins-medium text-[14px] text-[#646464]">Construcción 95.36 m²</Text>

                                        <Pressable onPress={() => router.push("/(private)/(accommodation)")} className="w-full rounded-[16px] py-[12px] bg-[#94A604] border-[1.5px] border-[#94A604] items-center">
