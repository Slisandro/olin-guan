...
import { Bed, Bus, Clock, MapIcon, Star } from "lucide-react-native";
...
const CATEGORIES = [
    { id: 1, label: "Transport", icon: <Bus size={20} /> },
    { id: 2, label: "Guide", icon: <MapIcon size={20} /> },
    { id: 3, label: "Meals", icon: <PlateUtensilsIcon size={"extra-large"} /> },
    { id: 5, label: "Nightlife", icon: <Bed size={20} /> }
];
        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">Trattoria Roma</Text>
                </View>

                <View className="bg-white flex-1 mt-[10px] gap-[30px] pb-[30px] w-full">
                    <Pressable style={styles.container} className='shadow-soft-gray rounded-[16px] bg-red'>
                        ...
                        <SafeAreaView style={styles.content}>
                            <View style={styles.box}>
                                <Text style={styles.titleLarge}>An unforgettable journey through history</Text>
                                <Text style={styles.titleSmall}>Discover the Wonders of Cancún</Text>
                                <Pressable className="bg-[#FCF9E4] w-auto mr-auto rounded-[12px] py-[8px] px-[30px]">
                                    <Text className="text-[#CAA900] font-poppins-semibold text-[12px]">Watch video</Text>
                                </Pressable>
                            </View>
                        </SafeAreaView>
                    </Pressable>
                    ...
                    <View className="flex gap-[15px] px-[20px]">
                        <Text className='font-poppins-bold font-700 text-[16px] text-text-600 leading-[19px]'>
                            Historical, Scenic, Adventurous
                        </Text>

                        <Text className='font-poppins-bold font-700 text-[20px] text-[#1B77F2]'>
                            Cancún Adventure
                        </Text>

                        <Text className='font-poppins text-[14px] text-[#646464]'>
                            Explore the ancient Inca city with a guided tour, including transport, meals, and entrance fees.
                        </Text>

                        <View className="w-auto px-[12px] py-[5px] rounded-[16px] right-[16px] backdrop-blur-[50px] flex flex-row items-center">
                            <StarIcon size='small' fill={"#F2CB04"} />
                            <Text className="text-[#646464] ml-1 text-[12px] font-poppins-bold font-700">
                                5.0/150
                            </Text>
                        </View>
                        ...
                        <View className="items-center justify-between flex-row gap-2">
                            {
                                CATEGORIES.map(cat => (
                                    <View key={cat.id} className="items-center mx-">
                                        {cat.icon}
                                        <Text className="text-[#646464] text-[12px] font-500">
                                            {cat.label}
                                        </Text>
                                    </View>
                                ))
                        ...
                        <Text className="ml-auto text-[#8A8A8A] text-[14px] font-poppins-bold">View all amenities {">"}</Text>
                        ...
                        <View className="gap-2 flex-row items-center">
                            <Text className="border border-[#1B77F2] text-[#646464] text-[16px] font-poppins-semibold px-[16px] py-[12px] w-auto rounded-[12px]">
                                1
                            </Text>
                            <View className="flex-1">
                                <Text className="text-[#646464] text-[16px] font-poppins-bold w-auto rounded-[12px]">
                                    Day 1-12pm
                                </Text>
                                <Text className="text-[#646464] text-[12px] font-poppins w-auto rounded-[12px]">
                                    Arribal and city tour.
                                </Text>
                            </View>
                        </View>

                        <View className="w-1 h-10 border-r-2 border-[#DDDDDD] rounded-md mx-4" />
                        ...
                        <View className="py-[20px] h-[480px]">
                            <Image
                                source={MAP}
                        ...
                        <Text className='font-[700] text-[16px] text-text-600 leading-[19px]'>
                            Total Price
                        </Text>
                        ...
                        <Pressable onPress={() => router.push("/(private)/(tour)/tour-reservation")} className="w-full rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                            <Text className='text-[16px] font-poppins-semibold text-white'>Book now</Text>
                        </Pressable>

                        <Text className="font-inter-regular font-400 text-[12px] text-[#8A8A8A] leading-[16px]">Experience the best of Peru with our all-inclusive tour.</Text>
                        ...
                        <Pressable onPress={() => router.push("/(private)/(tour)/tour-reservation")}  className="w-full rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                            <Text className='text-[16px] font-poppins-semibold text-white'>Add to itinerary</Text>
                        </Pressable>
                    </View>
                </View>
            </ScrollView>
    ...
    return (
        <View className="gap-[16px] py-[16px]">
            {ITEMS_BEST_FOOD.map(item => (
                <Pressable key={item.id} onPress={() => router.push("/(private)/(plan_trip)/booking-restaurant")} className="bg-white gap-2 rounded-[16px] w-auto h-auto shadow-sm">
...
import PlateUtensilsIcon from "@/components/icons/food/plate-utensils/plate-utensils";
...
const BestPlaces = () => {
    const renderItem = ({ item }: { item: BestPlaceItem }) => {
        return (
            <View className="bg-white gap-2 rounded-[16px] w-auto h-auto shadow-sm">
                <View className='w-[280px] h-[150px]'>
                    <ImageExpo
                ...
                <View className="px-[12px] py-[10px] min-h-[56px] gap-1">
                    <Text className="font-poppins-bold font-700 text-[16px] text-[#1B77F2]">{item.title}</Text>

                    <View className="relative flex-row items-center gap-2">
                        <CALENDAR />
                        <Text className="text-[#646464] text-[12px] font-poppins-bold">Daily</Text>
                    </View>

                    <View className="relative flex-row items-center gap-2">
                        <Clock color={"#646464"}
                            strokeWidth={1.5} />
                        <Text className="text-[#646464] text-[12px] font-poppins-bold">5:30 AM</Text>
                    </View>
                    <Text className="font-inter-regular font-400 text-[12px] text-[#8A8A8A] leading-[16px]">Capture the breathtaking sunrise.</Text>
                </View>
            </View>
        )
    };
    ...
    return (
        <FlatList
            ...
            className='mt-2 mb-4 pb-1 mr-[10px]'
