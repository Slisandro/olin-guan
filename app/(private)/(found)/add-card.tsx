...
export default function AddCard() {
    ...
    useEffect(() => {
        if (loading) {
            setTimeout(() => {
                router.push("/(private)/(found)/list-cards")
            }, 1000);
        }
    }, [loading])
        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white">Add card</Text>
                ...
                <View className="bg-white flex-1 mt-[10px] pt-[30px] gap-[20px] px-[20px] pb-[30px] w-full">
                    <Text className='font-poppins-bold font-700 text-[16px] text-text-600 leading-[19px]'>
                        Enter your credit card in the box below.
                    </Text>

                    <Text className="text-[#646464] font-poppins-bold text-[12px]">Account holder name</Text>
                    ...
                    <Text className="text-[#646464] font-poppins-bold text-[12px]">Card number</Text>

                    <View className="relative flex-row shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                        <View className="absolute top-0 bottom-0 left-6 items-center justify-center">
                            <MASTERCARD />
                        </View>
                        <TextInput placeholderTextColor={"#AAABAD"} className="ml-20 text-[#646464] text-[14px] font-[500]" placeholder="Write here" />
                    </View>

                    <View className="flex-row items-center gap-4">
                        <View className="flex-1 gap-4">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">Expiration date</Text>

                            <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="MM/AA" />
                            </View>
                        </View>
                        <View className="flex-1 gap-4">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">CVV</Text>

                            <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="CVV" />
                            </View>
                        </View>
                    </View>
