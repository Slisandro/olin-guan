            ...
            >
                ...
                >
                    <View
                        ...
                        className="bg-white py-4 px-3 justify-between"
                        style={{
                    ...
                    >
                        <Pressable
                            ...
                            className='relative p-[10px] shadow-soft-gray rounded-[16px] bg-red'
                        >
                            <Image
                        ...
                        {/* @ts-ignore */}
                        <Pressable onPress={() => router.push("/(private)/(accommodation)/detail")} className="w-full rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                            <Text className='text-[16px] font-poppins-semibold text-white'>See more</Text>
                        </Pressable>
                    </View>
                </Pressable>
            </Modal>
...
const BestHotels = ({ setModal }: { setModal: (b: boolean) => void }) => {
    ...
    const renderHotelItem = ({ item }: { item: BestHotelItem }) => (
        <Pressable onPress={() => setModal(true)} className="bg-white rounded-[16px] shadow-100 w-[300px]">
            <View className="flex gap-[8px] p-[16px]">
                <Text className="font-poppins-bold text-[16px] text-text-600 leading-[22px]">
                    {item.title}
                </Text>
            ...
            <View className="flex-row flex-wrap gap-[8px] p-[16px]">
                {
                    ["Very reserved", "Breakfast included", "Flexible policy"]
                        .map((item) =>
                            <View className="shadow-md shadow-[#00000000] bg-white px-2 py-1 rounded-[12px]">
                                <Text className="text-[#646464] text-[10px]">{item}</Text>
                            </View>
                        )
                }
            </View>
