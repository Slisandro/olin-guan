...
import { Bike, Building, Clock, Hotel, Map, Martini, ShoppingBag, Utensils } from "lucide-react-native";
            ...
            >
                ...
                <View className="bg-white flex-1 mt-[10px] pt-[30px] gap-[30px] px-[20px] pb-[30px] w-full">
                    <View className="flex gap-[15px]">
                        ...
                        <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                            <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="Select service" />
                        </View>
                        ...
                        <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                            <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500] h-16" placeholder="Notes" multiline />
                        </View>
