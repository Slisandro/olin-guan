        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">Experience the sea your way</Text>
                ...
                <View className="bg-white flex-1 mt-[20px] pt-[30px] gap-[20px] px-[20px] pb-[30px] w-full">
                    <View className="flex-row items-center justify-between">
                        ...
                        <Svg
                            ...
                            fill="none"
                        >
                            <G clipPath="url(#clip0_1_26471)">
                                <Path
                                    d="M16.966 9.518l-4.965 4.965-4.966-4.965"
                                    stroke="#646464"
                                    strokeWidth={1.5}
                                    strokeMiterlimit={10}
                                    strokeLinecap="round"
                    ...
                    <View className="flex-row justify-between">
                        {
                            ["All", "Luxury", "Party", "Familiar", "Sport"]
                                .map((text) => (
                                    <Text className="text-[#646464] text-[14px] font-poppins-semibold">{text}</Text>
                                ))
                        }
                    </View>
                    ...
                    <View className="bg-white w-full">
                        <FlatList
                            renderItem={({ item }) => (
                                <Pressable
                                    className={`bg-white rounded-[16px] h-auto shadow-sm shadow-[#97C3FF66] w-full my-2 ${item == 1 ? "border-2 border-[#94A604]" : "border-2 border-transparent"}`}
                                    onPress={() => router.push("/(private)/(yacht)/detail")}
                                >
                                    <View className='h-[200px] flex-row gap-2 p-2'>
                                        <ImageExpo
                                            source={require("@/assets/images/components/best-places-slider/best-places-slider-1.png")}
                                            style={{ borderRadius: 16, width: "48%", height: "100%" }}
                                            contentFit='cover'
                                        />
                                        <ImageExpo
                                            source={require("@/assets/images/components/best-places-slider/best-places-slider-1.png")}
                                    ...
                                    <View className="h-auto px-[12px] pt-[5px] pb-[10px] flex-1 gap-2">
                                        <View className="flex-row justify-between">
                                            <Text className="font-poppins-bold font-700 text-[16px] text-text-600">Ocean Breeze</Text>
                                            <View className="flex-row items-center gap-2">
                                                <StarIcon color="#F2CB04" fill="#F2CB04" />
                                                <Text className="font-poppins-bold font-700 text-[16px] text-text-600">5.0</Text>
                                            </View>
                                        </View>
                                        <Text className="font-poppins font-400 text-[14px] text-[#8A8A8A]">Spacious yacht perfect for parties</Text>
                                        <Text className="font-poppins font-400 text-[14px] text-[#8A8A8A]">Pto Vayrat</Text>
                                        <Text className="font-poppins-bold text-[20px] text-[#444444]">$600/day</Text>
                                    </View>
                                </Pressable>
                            )}
                            data={[1, 2]}
    ...
    return (
        <View className="gap-[16px] py-[16px]">
            {ITEMS_BEST_FOOD.map(item => (
                <Pressable key={item.id} onPress={() => router.push("/(private)/(yacht)/detail")} className="bg-white gap-2 rounded-[16px] w-auto h-auto shadow-sm">
