        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white">Change password</Text>

                </View>

                <View className="bg-white flex-1 mt-[20px] pt-[30px] gap-[10px] px-[20px] pb-[30px] w-full">
                    <Text className="text-[#646464] font-poppins-bold text-[12px]">New password</Text>
                    <View className="w-full flex-row border border-[#44444440] items-center bg-white rounded-12 pl-[10px] py-[13px] px-[20px]">
                    ...
                    <Text className="text-[#646464] font-poppins-bold text-[12px]">Repeat new password</Text>
                    <View className="w-full flex-row border border-[#44444440] items-center bg-white rounded-12 pl-[10px] py-[13px] px-[20px]">
                        <LockIcon color={isValid ? "#94A604" : "#646464"} size="medium" />
                        <TextInput
                            value={password}
                    ...
                    <Pressable onPress={() => setLoading(true)} className="flex flex-row items-center justify-center gap-[4px] py-[12px] w-full bg-[#1B77F2] rounded-[12px] mt-auto">
                        <Text className="text-white font-poppins-semibold font-[600] text-[16px] ">Change password</Text>
                    </Pressable>
                </View>
            </ScrollView>
        </LinearGradient>
