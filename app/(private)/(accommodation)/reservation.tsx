        ...
        >
                    ...
                    <BlurView intensity={25} className="absolute flex-1 inset-0 z-50 items-center justify-center bg-[#FFFFFF6B]">
                        <View className="items-center justify-center p-10 rounded-2xl bg-white w-[90%] gap-[16px]">
                            ...
                            <View className="flex-row justify-between w-full">
                                <Pressable onPress={() => setDelete(false)} className="w-[45%] rounded-[16px] py-[16px] bg-[#D9E6F8] border-[1.5px] border-[#1B77F2] items-center">
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">Booking</Text>
                </View>

                <View className="bg-white flex-1 mt-[10px] pt-[30px] gap-[30px] px-[20px] pb-[30px] w-full">
                    <View className="flex gap-[15px]">
                        ...
                        <View className="flex-row justify-between items-center">
                            <View className="flex-row items-center gap-2">
                                <CALENDAR />
                                <Text className="text-[#646464] text-[14px] font-poppins-medium">08 Aug 25-12 Aug 25</Text>
                            </View>
                            <View className="flex-row items-center gap-2">
                                <Svg
                                    width={24}
                                ...
                                <Text className="text-[#646464] text-[14px] font-poppins-medium">2 persons</Text>
                            </View>
                        </View>

                        <View className="flex-row justify-between items-center">
                            <Text className="text-[#646464] text-[16px] font-poppins-medium">Final price</Text>

                            <Text className="text-[#646464] text-[16px] font-poppins-bold">$600</Text>
                        </View>
                        ...
                        <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                            <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="Select a method" />
                        </View>
                        ...
                        <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                            <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="Enter code" />
                        </View>
                        ...
                        <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                            <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500] h-16" placeholder="Enter code" multiline />
                        </View>
