...
import { CarIcon, Clock, User } from "lucide-react-native";
        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">Rent the car for your adventure</Text>
                    {/* 
                ...
                <View className="bg-white flex-1 mt-[20px] pt-[30px] gap-[20px] px-[20px] pb-[30px] w-full">
                    ...
                    <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                        <View className="absolute top-0 bottom-0 left-[10px] flex items-center justify-center">
                            <CarIcon strokeWidth={"1.5"} color="#646464" />
                        </View>
                    ...
                    {/* @ts-ignore */}
                    <Pressable onPress={() => router.push("/(private)/(car)")} className="w-full rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                        <Text className='text-[16px] font-poppins-semibold text-white'>Search cars</Text>
                    </Pressable>
                </View>
            </ScrollView>
        </LinearGradient>
