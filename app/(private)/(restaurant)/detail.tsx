        ...
        >
            ...
            >
                ...
                <View className="bg-white flex-1 mt-[10px] gap-[20px] pb-[30px] w-full">
                    ...
                    <View className="px-[30px] w-auto pt-[20px] rounded-[16px] right-[16px] backdrop-blur-[50px] flex flex-row items-center gap-2">
                    ...
                    <View className="flex gap-[15px] px-[20px]">
                        ...
                        <Text className='font-poppins text-[14px] text-[#646464]'>
                            A cozy place with a modern vibe, offering a delightful mix of local and international cuisines.
                        </Text>

                        <View className="flex-row items-center justify-between">
                            <View className="h-auto gap-3">
                                <Text className='font-poppins-bold font-700 text-[16px] leading-[19px] text-[#1B77F2]'>{"Bookings"}</Text>
                                <View className="h-[4px] border-2 border-[#1B77F2] mt-auto w-full" />
                            </View>

                            {
                                ["Reviews", "Map", "Services"].map((item) =>
                        ...
                        <View className="flex-row justify-between items-center">
                            {
                                [1, 2, 3, 4, 5, 6, "+"].map(item => (
                                    <View className="shadow-lg shadow-[#97C3FF66] rounded-full p-2 bg-white" style={{ shadowColor: "#97C3FF66", borderRadius: "100%" }} key={item}>
                                        <Text className="text-[#8A8A8A] text-[20px]">
                                            {item}
                                        </Text>
                                    </View>
                                ))
                        ...
                        <Pressable onPress={() => setDelete(true)} className="flex-1 rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                            <Text className='text-[16px] font-poppins-semibold text-white'>Reserve Table</Text>
                        </Pressable>
