        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white text-center">Search results</Text>
                ...
                <View className="bg-white flex-1 mt-[30px] pt-[20px] px-[20px] pb-[30px] w-full">
                    ...
                    {/* <View className="flex gap-[15px]">
                        ...
                        <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                            <View className="absolute top-0 bottom-0 left-2 items-center justify-center">
                                <Svg
                                    width={24}
                                    height={24}
                                    viewBox="0 0 24 24"
                                ...
                                >
                                    <Path
                                        d="M8 7v14m4-3v3m-9 0h12M4 13v.96c0 .845 0 1.268.201 1.616.201.348.567.56 1.3.982L8 18m4-9v2.96c0 .845 0 1.268-.201 1.616-.201.348-.567.56-1.3.982L8 16M18 9a3 3 0 100-6 3 3 0 000 6z"
                                        stroke="#646464"
                                        strokeWidth={1.5}
                                        strokeLinecap="round"
                            ...
                            <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500] pl-8" placeholder="Write here" />
                        </View>
                        ...
                        <View className="flex flex-row justify-between gap-[20px]">
                            <View className="gap-[9px] w-[45%]">
                                <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                    ...
                                    <TextInput placeholderTextColor={"#646464"} className="ml-10 text-[#646464] text-[14px] font-[500]" placeholder="Start time" />
                                </View>
                            </View>
                            ...
                            <View className="gap-[9px] w-[45%]">
                                <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                    ...
                                    <TextInput placeholderTextColor={"#646464"} className="ml-10 text-[#646464] text-[14px] font-[500]" placeholder="End time" />
                                </View>
                            </View>
                        </View>
                    </View>
...
const BestFood = () => {
    const router = useRouter();
    return (
        <View className="gap-[16px] py-[16px] w-full flex-1">
            {ITEMS_BEST_FOOD.map(item => (
                <Pressable key={item.id} onPress={() => router.push("/(private)/(restaurant)/detail")} className="bg-white gap-2 rounded-[16px] w-full h-auto shadow-sm flex-row">
                    <View className='h-[170px] w-1/3' style={{ borderRadius: 0, borderBottomLeftRadius: 16, borderTopLeftRadius: 16 }}>
                        <Image
                            source={item.images[0]}
                            style={{ borderRadius: 0, borderBottomLeftRadius: 16, borderTopLeftRadius: 16, width: 130, height: "100%" }}
                            resizeMode='cover'
                        />
                    </View>
                    <View className="px-[20px] py-[12px] w-2/3 gap-2 justify-between">
                        <View className="flex-row gap-1 items-center">
                            <LOCATION />
                            <Text className="font-poppins-bold font-700 text-[16px] leading-[20px] text-[#000000CC]">{item.title} 123</Text>
                        </View>

                        <View className="flex-row gap-1 items-center">
                            <Star fill="#F2CB04" color="#F2CB04" size={16} />
                            <Text className="font-poppins-bold font-700 text-[12px] leading-[20px] text-[#000000CC]">4.5</Text>
                            <Text className="font-poppins-bold font-700 text-[12px] leading-[20px] text-[#000000CC]">· Italiana</Text>
                            <Text className="font-poppins-bold font-700 text-[12px] leading-[20px] text-[#000000CC]">· $20-$250</Text>
                        </View>

                        <View className="flex flex-row gap-[8px] mt-[4px]">
                            <Text style={{ borderColor: "#D9E6F8" }} className="font-inter-regular bg-[#EFF0F3] border border-[#D9E6F8] p-2 rounded-md font-400 text-[13px] text-text-600 leading-[13px]">Vegan</Text>
                            <Text style={{ borderColor: "#D9E6F8" }} className="font-inter-regular bg-[#EFF0F3] border border-[#D9E6F8] p-2 rounded-md font-400 text-[13px] text-text-600 leading-[13px]">Familiar</Text>
                            <Text style={{ borderColor: "#D9E6F8" }} className="font-inter-regular bg-[#EFF0F3] border border-[#D9E6F8] p-2 rounded-md font-400 text-[13px] text-text-600 leading-[13px]">Bar</Text>
                        </View>

                        <Pressable className="w-full bg-[#FCF9E4] border border-[#F2CB04] rounded-xl py-2 items-center">
                            <Text style={{ color: "#F2CB04" }} className="text-[#F2CB04] text-[12px] font-poppins-semibold">Book a table</Text>
                        </Pressable>
                    </View>
                </Pressable>
            ))}
