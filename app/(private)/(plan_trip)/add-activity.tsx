...
import { Bike, Building, Hotel, Map, Martini, ShoppingBag, Utensils } from "lucide-react-native";
        ...
        >
            ...
            >
                <View className="px-[20px] pt-[50px] gap-[12px] items-center">
                    ...
                    <Text className="text-[20px] font-poppins-bold text-white">Add activity to the day [X]</Text>

                    <Text className="text-[14px] font-poppins-bold text-white">June-25</Text>

                    <View className="w-full flex-row flex-wrap justify-center gap-3 mt-4">

                        {CATEGORIES.map(cat => (
                            <Pressable
                                key={cat.id}
                                className="flex-row items-center gap-2 px-4 py-2 bg-[#D9E6F8] rounded-full"
                                style={{ elevation: 3 }}
                            >
                                {cat.icon}

                                <Text className="text-[#004BAF] font-poppins-medium text-[14px]">
                                    {cat.label}
                                </Text>

                                <Checkbox className="w-[10px] h-[10px] bg-white rounded-full" />
                            </Pressable>
                        ))}
                ...
                <View className="bg-white flex-1 rounded-t-[40px] mt-[30px] pt-[30px] gap-[30px] px-[20px] pb-[30px] w-full">
                        ...
                        <View className="flex flex-row justify-between gap-[20px]">
                            <View className="gap-[9px] w-[45%]">
                                ...
                                <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                    ...
                                    <TextInput placeholderTextColor={"#646464"} className="ml-10 text-[#646464] text-[14px] font-[500]" placeholder="01:00 " />
                                </View>
                            </View>
                    ...
                    <View className="flex gap-[20px]">
                        ...
                        <View className="gap-[9px]">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">Name of the place or activity</Text>
                            <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                        ...
                        <View className="gap-[9px]">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">Description/Notes (Optional)</Text>
                            <View className="relative shadow-black/25 shadow-sm px-[10px] h-[80px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] h-full text-[14px] font-[500]" placeholder="Write here" multiline={true} />
                            </View>
                        </View>

                        <View className="gap-[9px]">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">Address or location</Text>
                            <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="Write here" />
                            </View>
                        </View>
                        ...
                        <View className="gap-[9px]">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">Reference or reservation link (Optional)</Text>
                            <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="Write here" />
                            </View>
                        </View>

                        <Pressable className="flex-row px-[10px] py-[15px] rounded-[12px] bg-[#D9E6F8] text-[#646464] text-[14px] font-[500] items-center gap-[12px] justify-center">
                            <UPLOAD />
                            <Text className="text-[#646464] font-[500] text-[14px]">Upload image or PDF of the receipt</Text>
                        </Pressable>

                        <View className="gap-[9px]">
                            <Text className="text-[#646464] font-poppins-bold text-[12px]">Estimated amount (Optional)</Text>
                            <View className="relative shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#AAABAD"} className="text-[#646464] text-[14px] font-[500]" placeholder="Write here" />
                            </View>
                        </View>
                    ...
                    <View className='gap-4'>
                        ...
                        <View className='flex gap-[16px]'>
                            ...
                            <Pressable onPress={() => setDelete(false)} className="w-full rounded-[16px] py-[16px] bg-[#DADFB5] border-[1.5px] border-[#94A604] items-center">
                                <Text className='text-[16px] font-poppins-semibold text-[#94A604]'>Confirm and reserve QR</Text>
                            </Pressable>
                        </View>

                        <View className="border-[1px] border-[#A6A7AE] w-full" />

                        <View className="flex-row justify-between">
                            <Pressable onPress={() => setLoading(true)} className="w-[49%] rounded-[16px] py-[16px] bg-[#D9E6F8] border-[1.5px] border-[#1B77F2] items-center">
                                <Text className='text-[16px] font-poppins-semibold text-[#1B77F2]'>Cancel</Text>
                            </Pressable>

                            <Pressable onPress={() => setLoading(true)} className="w-[49%] rounded-[16px] py-[16px] bg-[#1B77F2] border-[1.5px] border-[#1B77F2] items-center">
                                <Text className='text-[16px] font-poppins-semibold text-white'>Save activity</Text>
                            </Pressable>
                        </View>
                    </View>
                </View>
