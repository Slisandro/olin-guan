...
export default function Index() {
    ...
    const [travelingWith, setTravelingWith] = useState("Alone");
                    ...
                    <View className="flex gap-[20px]">
                        ...
                        <View className="flex flex-row justify-between gap-[20px]">
                            <View className="relative flex-1 shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#646464"} className="text-[#646464] text-[14px] font-[500]" placeholder="Start date" />
                            ...
                            <View className="relative flex-1 shadow-black/25 shadow-sm px-[10px] py-[15px] bg-white rounded-[12px]">
                                <TextInput placeholderTextColor={"#646464"} className="text-[#646464] text-[14px] font-[500]" placeholder="End date" />
                                <View className="absolute top-0 bottom-0 right-[10px] flex items-center justify-center">
                                    <CALENDAR />
                                </View>
                            </View>
