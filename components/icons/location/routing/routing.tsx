...
const RoutingIconExtraLarge: React.FC<RoutingIconProps> = ({ color }) => (
    <Svg
        width={24}
        height={24}
        fill="none"
...
const RoutingIconLarge: React.FC<RoutingIconProps> = ({ color }) => (
    <Svg
        width={20}
        height={20}
        fill="none"
...
const RoutingIconMedium: React.FC<RoutingIconProps> = ({ color }) => (
    <Svg
        width={18}
        height={18}
        fill="none"
...
const RoutingIconSmall: React.FC<RoutingIconProps> = ({ color }) => (
    <Svg
        width={14}
        height={14}
        fill="none"
...
const RoutingIconExtraSmall: React.FC<RoutingIconProps> = ({ color }) => (
    <Svg
        width={12}
        height={12}
        fill="none"
