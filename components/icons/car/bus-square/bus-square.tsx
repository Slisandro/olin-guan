...
const BusSquareIconLarge: React.FC<BusSquareIconProps> = () => (
    <Svg
        width={24}
        height={24}
        fill="none"
...
const BusSquareIconMedium: React.FC<BusSquareIconProps> = () => (
    <Svg
        width={20}
        height={20}
        fill="none"
...
const BusSquareIconSmall: React.FC<BusSquareIconProps> = () => (
    <Svg
        width={18}
        height={18}
        fill="none"
